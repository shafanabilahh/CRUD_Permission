    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <div class="float-start">Add New Permission</div>
                <div class="float-end">
            ...
            <div class="card-body">
                <form action="{{ route('permissions.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('guard_name') is-invalid @enderror" id="guard_name" name="guard_name" value="{{ old('guard_name') }}">
